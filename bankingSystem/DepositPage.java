...
public class DepositPage extends JInternalFrame {
	/**
	 * 
	 */
	...
	public DepositPage() {
		...
		setTitle("Banking Management System - Deposit Page");
		...
		panel_2.setBorder(new TitledBorder(new TitledBorder(new BevelBorder(BevelBorder.LOWERED, null, null, null, null), "", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)), "Deposit", TitledBorder.LEFT, TitledBorder.TOP, null, new Color(0, 102, 204)));
		panel_2.setBounds(258, 168, 159, 130);
		getContentPane().add(panel_2);
		panel_2.setLayout(null);
		
		JLabel lblDeposit = new JLabel("Deposit");
		lblDeposit.setFont(new Font("Segoe UI Semibold", Font.BOLD, 14));
		lblDeposit.setBounds(10, 30, 104, 14);
		panel_2.add(lblDeposit);
		
		txtDeposit = new JTextField();
		txtDeposit.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 15));
		txtDeposit.setText("Rs.");
		txtDeposit.setBackground(new Color(135, 206, 235));
		txtDeposit.setBounds(40, 67, 86, 35);
		panel_2.add(txtDeposit);
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				try
				{
					...
					String amnt = txtDeposit.getText().substring(3);
